...
Machine.prototype.rsize = function () {
    ...
    //this.width = suite.canvasEl.width = $( "h1" ).width();
    this.width = suite.canvasEl.width = document.getElementById("content").clientWidth;
    var body = document.body,
        html = document.documentElement;
    var tmph = Math.max( body.scrollHeight, body.offsetHeight,
                html.clientHeight, html.scrollHeight, html.offsetHeight );
    this.height = suite.canvasEl.height = Math.round(tmph*0.6);
    //jquery specific
    //this.height = suite.canvasEl.height = Math.round($( document ).height()*0.6);
